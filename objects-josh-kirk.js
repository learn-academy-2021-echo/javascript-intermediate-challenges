...
person.fromThirdRock = function(){console.log(`${this.firstName} ${this.lastName} is from planet ${this.homePlanet}`);}
...
lunch.description = function() { return `The ingredients for a ${this.name} ${this.type} are ${this.ingredients[0]}, ${this.ingredients[1]}, ${this.ingredients[2]}.`}
