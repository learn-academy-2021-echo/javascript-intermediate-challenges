...
const oddNumFunct = (array) => {
    let oddNum = []
    //create a for loop that will cycle through numbers and if the number is odd store it in the new array called oddNum
    for (let i = 0; i < array.length; i++) {
        if(array[i] % 2 === 0){
        } else{
            oddNum.push(array[i])
...
console.log(oddNumFunct(testArr2));
...
// // STRETCH: As a user, if I have not guessed the correct number in seven tries I see a losing message. 2, 3]
// // // --> 1
// // STRETCH Challenges
